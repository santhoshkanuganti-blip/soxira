...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `https://${siteConfig.domain}/data-engineering-snowflake-dbt` },
  description:
      ...
      <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <article className="space-y-10">
          <header className="space-y-4">
            <p className="inline-flex rounded-full bg-surface-2 px-4 py-2 text-sm uppercase tracking-[0.3em] text-accent">Data Engineering</p>
            <h1 className="text-4xl font-semibold tracking-tight text-ink sm:text-5xl">Snowflake DBT Consulting for Analytics-first Organizations</h1>
          ...
          <section className="grid gap-8 lg:grid-cols-2">
            <div className="rounded-[2rem] border border-line bg-surface p-8 shadow-2xl">
              <h2 className="text-2xl font-semibold text-ink">Our data engineering strengths</h2>
            ...
            <div className="rounded-[2rem] border border-line bg-surface p-8 shadow-2xl">
              <h2 className="text-2xl font-semibold text-ink">Benefits for your team</h2>
              <ul className="mt-6 space-y-4 text-ink-muted">
          ...
          <section className="space-y-6 rounded-[2rem] border border-line bg-surface-2 p-8 shadow-2xl">
            <h2 className="text-3xl font-semibold text-ink">Trusted by enterprises</h2>
            <div className="grid gap-4 sm:grid-cols-3">
              {['Snowflake', 'DBT', 'Analytics', 'Governance'].map((capability) => (
                <div key={capability} className="rounded-3xl bg-surface-2 p-6 text-ink ring-1 ring-line">
                  ...
                  <p className="mt-3 text-ink-muted">Efficient, scalable and secure data engineering support.</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/solutions/data-engineering-for-insurance" className="rounded-xl border border-line bg-surface px-4 py-2.5 text-sm text-ink-muted transition hover:bg-surface-2 hover:text-ink">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="max-w-xl text-ink-muted">We deliver data pipelines crafted for Indian enterprises and distributor ecosystems.</p>
          </div>
        </article>
      </main>
      <CTA />
